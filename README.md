...
8. `Harness/state.md`에 현재 프로젝트 상태를 기록한다.
9. `Harness/next.md`에 다음 작업 후보와 수동 검증 필요 항목을 기록한다.
10. 작업 시작 날짜의 `Harness/cycles/YYYY-MM-DD.md`를 만들고 초기화 내용을 남긴다.
...
11. `Harness/scripts/unreal/`, `Harness/scripts/build/`, `Harness/scripts/tools/`
...
- 템플릿 버전 업 시 `HARNESS.md`, 루트 에이전트 지시 파일, `Harness/README.md`, `Harness/config/agents.json`, `Harness/config/cycle_policy.json`, `Harness/scripts/unreal/`, `Harness/scripts/build/`, `Harness/scripts/tools/`는 갱신 대상이다.
