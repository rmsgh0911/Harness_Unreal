...
Do not use as a work log, history journal, or human dashboard — that is `Harness/Codex/Progress.md`.
...
- TODO: If design docs, specs, simulation scenarios, or validation criteria exist, record whether they live in `Harness/Common/docs/` or a registered external docs folder in `Harness/Codex/config/docs.json`.
- `Harness/Codex/Progress.md` is a Korean human-facing dashboard, not a technical state source.
