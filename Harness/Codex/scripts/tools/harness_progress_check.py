...
PROGRESS_RELATIVE = "Harness/Codex/Progress.md"
...
def build_report(root: Path) -> dict:
    ...
    return {
        ...
        "guidance": [
            ...
            "Refresh existing bullets in place and move detailed history to Harness/Codex/work/cycles/.",
        ],
    }
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Check Harness/Codex/Progress.md for dashboard bloat.")
