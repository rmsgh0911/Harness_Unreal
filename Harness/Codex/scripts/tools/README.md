...
- Project-specific values can come from `Harness/Codex/config/project.json` or command-line arguments.
...
```powershell
python Harness/Codex/scripts/tools/example_tool.py --help
python Harness/Codex/scripts/tools/example_tool.py --json
python Harness/Codex/scripts/tools/example_tool.py --write
```
...
- `harness_index_check.py`: checks whether `Harness/Codex/index/` stays compact, complete, and fresh enough.
...
python Harness/Codex/scripts/tools/harness_context.py --request "Improve lock-on input flow"
python Harness/Codex/scripts/tools/harness_doctor.py --json
python Harness/Codex/scripts/tools/harness_docs_check.py --json
python Harness/Codex/scripts/tools/harness_scan.py --json
python Harness/Codex/scripts/tools/harness_cycle.py "Input fix" --changed "..." --verified "..." --remaining "..."
python Harness/Codex/scripts/tools/harness_diff_guard.py
python Harness/Codex/scripts/tools/harness_handoff.py --request "Continue lock-on work"
python Harness/Codex/scripts/tools/harness_verify_all.py
python Harness/Codex/scripts/tools/harness_release_check.py --json
...
python Harness/Codex/scripts/tools/harness_migration_audit.py --target C:\Path\To\OldProject
python Harness/Codex/scripts/tools/harness_state_check.py --target C:\Path\To\Project
python Harness/Codex/scripts/tools/harness_progress_check.py --json
python Harness/Codex/scripts/tools/harness_python_check.py
python Harness/Codex/scripts/tools/harness_init_plan.py
python Harness/Codex/scripts/tools/harness_docs_index.py
python Harness/Codex/scripts/tools/harness_index_check.py --json
python Harness/Codex/scripts/tools/harness_project_fill.py --json
python Harness/Codex/scripts/tools/harness_cycle_summary.py
python Harness/Codex/scripts/tools/harness_unreal_risk.py
python Harness/Codex/scripts/tools/harness_unreal_script.py --script Harness/Codex/scripts/unreal/verify_project.py
```
...
- no generated `__pycache__` or `*.pyc` files remain under `Harness/Codex/scripts/`
