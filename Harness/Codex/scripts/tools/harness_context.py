...
def build_context(root: Path, request: str = "") -> dict:
    ...
    files = {
        ...
        "Harness/Codex/work/state.md": file_status(state_path(root)),
        "Harness/Codex/work/next.md": file_status(next_path(root)),
        "Harness/Codex/index/project_index.md": file_status(index_dir(root) / "project_index.md"),
        "Harness/Codex/index/api_surface.md": file_status(index_dir(root) / "api_surface.md"),
        "Harness/Codex/index/verification_map.md": file_status(index_dir(root) / "verification_map.md"),
    }
    ...
    return {
        ...
        "cycle_policy": {
            ...
            "tool_directory": cycle_policy.get("tool_policy", {}).get("default_tool_directory", "Harness/Codex/scripts/tools"),
