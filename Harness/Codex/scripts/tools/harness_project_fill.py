"""Generate or fill Harness/Codex/config/project.json from project structure."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fill empty Harness/Codex/config/project.json fields from project structure.")
    parser.add_argument("--root", type=Path, default=None, help="Project root. Defaults to nearest Harness root.")
    parser.add_argument("--write", action="store_true", help="Write merged values to Harness/Codex/config/project.json.")
