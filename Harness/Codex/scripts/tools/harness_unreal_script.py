...
DEFAULT_SCRIPT = "Harness/Codex/scripts/unreal/verify_project.py"
UNREAL_SCRIPT_ROOT = Path("Harness/Codex/scripts/unreal")
...
def build_report(root: Path, script: str = DEFAULT_SCRIPT, extra_args: list[str] | None = None) -> dict:
    ...
    try:
        ...
        missing.append("script must stay under Harness/Codex/scripts/unreal")
