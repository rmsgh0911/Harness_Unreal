...
- Added `harness_memory_review.py` and wired it into `harness_local_gate.py`, giving no-CI projects a read-only commit/push memory-candidate check without auto-logging command output or temporary state.
