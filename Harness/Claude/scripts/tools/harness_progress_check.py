...
PROGRESS_RELATIVE = "Harness/Claude/Progress.md"
...
def build_report(root: Path) -> dict:
    ...
    return {
        ...
        "guidance": [
            ...
            "Refresh existing bullets in place and move detailed history to Harness/Claude/work/cycles/.",
        ],
    }
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Check Harness/Claude/Progress.md for dashboard bloat.")
