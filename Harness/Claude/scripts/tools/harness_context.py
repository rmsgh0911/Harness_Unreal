...
def build_context(root: Path, request: str = "") -> dict:
    ...
    files = {
        ...
        "Harness/Claude/work/state.md": file_status(state_path(root)),
        "Harness/Claude/work/next.md": file_status(next_path(root)),
        "Harness/Claude/index/project_index.md": file_status(index_dir(root) / "project_index.md"),
        "Harness/Claude/index/api_surface.md": file_status(index_dir(root) / "api_surface.md"),
        "Harness/Claude/index/verification_map.md": file_status(index_dir(root) / "verification_map.md"),
    }
    ...
    return {
        ...
        "cycle_policy": {
            ...
            "tool_directory": cycle_policy.get("tool_policy", {}).get("default_tool_directory", "Harness/Claude/scripts/tools"),
