...
def run_doctor(root: Path) -> dict:
    ...
    required_files = [
        ...
        root / "Harness" / "Codex" / "README.md",
        root / "Harness" / "Codex" / "Progress.md",
        root / "Harness" / "Codex" / "config" / "project.json",
        root / "Harness" / "Codex" / "work" / "state.md",
        root / "Harness" / "Codex" / "work" / "next.md",
        root / "Harness" / "Codex" / "scripts" / "tools" / "tool_manifest.json",
        harness / "README.md",
    ...
    for path in json_paths:
        ...
        if path.name == "tool_manifest.json" and isinstance(data, dict):
            ...
            for index, tool in enumerate(tools, start=1):
                ...
                results.append(check(str(declared_path).startswith("Harness/Claude/scripts/tools/"), f"manifest tool stays under tools: {name}"))
