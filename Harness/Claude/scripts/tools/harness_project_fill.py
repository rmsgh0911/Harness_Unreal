"""Generate or fill Harness/Claude/config/project.json from project structure."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fill empty Harness/Claude/config/project.json fields from project structure.")
    parser.add_argument("--root", type=Path, default=None, help="Project root. Defaults to nearest Harness root.")
    parser.add_argument("--write", action="store_true", help="Write merged values to Harness/Claude/config/project.json.")
