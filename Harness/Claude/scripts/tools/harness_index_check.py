"""Check Harness/Claude/index files for compactness and basic freshness signals."""
...
def build_report(root: Path) -> dict:
    ...
    if not index.exists():
        errors.append({"path": "Harness/Claude/index", "message": "missing"})
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Check Harness/Claude/index compactness and required files.")
