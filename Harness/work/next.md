...
- Update `Harness/work/state.md` from actual Source, Config, and asset evidence.
...
- Create today's `Harness/work/cycles/YYYY-MM-DD.md` only when real project work should be recorded.
